...
const LoadingSkeleton = () => {
  return (
    <div className='flex h-screen w-[650px] flex-col items-center gap-6 rounded-xl p-4 opacity-70 md:p-10'>
      <Card className='h-fit w-full border-none bg-secondary/20'>
        <CardHeader className='flex-row gap-2 p-3'>
          ...
          <div>
            <CardTitle className='h-3 w-[150px] rounded-full bg-gray-200'></CardTitle>
            <CardDescription className='mt-3 h-3 w-[220px] rounded-full bg-gray-200'></CardDescription>
          </div>
        </CardHeader>
